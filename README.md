...
During this exercise I learned the practical parts of how a compiler creates a grammar specification from a language and uses it to parse code. This gave insight into how compilers go from a tokenized language to a semantic analysis, using abstract syntax trees. I also used two new tools, flex and bison, and it was interesting to understand how they form lexemes and provide the basis for effective parsing.
